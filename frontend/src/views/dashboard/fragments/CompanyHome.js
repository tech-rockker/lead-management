...
import ActivityChart from '../../stats/charts/ActivityChart'
import GoalSubGoal from '../../stats/charts/GoalSubGoal'
...
const CompanyHome = () => {
  ...
  return (
    <>
      <Header className='fw-bolder' title={FM('dashboard')}></Header>
      {/* {msToTime((93960000 / 5) * 30)} */}
      {loading ? (
        <>
          {' '}
        ...
        <Row>
          ...
          <Col lg='4' sm='6'>
            <Link to='/users/employees'>
              ...
              <StatsHorizontal
                ...
                statTitle={FM('no.-of-employees')}
              />{' '}
            </Link>
          </Col>
          <Col lg='4' sm='6'>
            <Link to='/users/patients'>
              {' '}
              <StatsHorizontal
                icon={<Users size={21} />}
                color='success'
                stats={dashboard?.dashboards?.patientCount}
                statTitle={FM('no.-of-patients')}
              />{' '}
            </Link>
          </Col>
          <Col lg='4' sm='6'>
            <Link to='/branch'>
              ...
              <StatsHorizontal
                icon={<List size={21} />}
                color='info'
                stats={dashboard?.dashboards?.branchCount}
                statTitle={FM('no.-of-branches')}
              />{' '}
            </Link>
          </Col>
            ...
            <Col lg='4' sm='6'>
              <Link to='/timeline'>
                ...
                <StatsHorizontal
                  ...
                  color='info'
                  stats={dashboard?.dashboards?.activityCount}
                  statTitle={FM('no.-of-activity')}
                />{' '}
              </Link>
            </Col>
          </Show>
            ...
            <Col lg='4' sm='6'>
              <Link to='/followups'>
                ...
                <StatsHorizontal
                  icon={<Slack size={21} />}
                  color='info'
                  stats={dashboard?.dashboards?.followupCount}
                  statTitle={FM('no.-of-follow up')}
                />{' '}
              </Link>
            </Col>
          </Show>
          <Col lg='4' sm='6'>
            <Link to='/journal'>
              ...
              <StatsHorizontal
                icon={<File size={21} />}
                color='info'
                stats={dashboard?.dashboards?.journalCount}
                statTitle={FM('no.-of-journal')}
              />{' '}
            </Link>
          </Col>
          <Col lg='4' sm='6'>
            <Link to='/deviation'>
              ...
              <StatsHorizontal
                ...
                color='info'
                stats={dashboard?.dashboards?.deviationCount}
                statTitle={FM('no.-of-deviation')}
              />{' '}
            </Link>
          </Col>
          <Show IF={ViewActivity}>
            ...
            <Col lg='4' sm='6'>
              <Link to='/timeline'>
                ...
                <StatsHorizontal
                  ...
                  color='warning'
                  stats={dashboard?.dashboards?.activityPendingCount}
            ...
            <Col lg='4' sm='6'>
              <Link to='/timeline'>
                ...
                <StatsHorizontal
                  ...
                  color='success'
                  stats={dashboard?.dashboards?.activityCompleteCount}
            ...
            <Col lg='4' sm='6'>
              <Link to='/timeline'>
                ...
                <StatsHorizontal
                  icon={<AlertTriangle size={21} />}
                  color='warning'
                  stats={dashboard?.dashboards?.activityNotApplicableCount}
                  statTitle={FM('no.-of-activity-not-applicable')}
                />{' '}
              </Link>
            </Col>
            <Col lg='4' sm='6'>
              <Link to='/timeline'>
                ...
                <StatsHorizontal
                  ...
                  color='danger'
                  stats={dashboard?.dashboards?.activityNotDoneCount}
                  statTitle={FM('no.-of-activity-not-done')}
                />{' '}
              </Link>
            </Col>
          </Show>
          ...
          <Col lg='4' sm='6'>
            <Link to='/implementation-plans' onClick={(e) => handleRead(e, 'no', 'ip')}>
              {' '}
              <StatsHorizontal
                icon={<AlertTriangle size={21} />}
                color='warning'
          ...
          {/* <Col lg='4' sm='6'>
                    <StatsHorizontal icon={<Database size={21}/>} color='primary' stats='37' statTitle={(FM("no.-of-department"))} />
                </Col> */}
          {/* <Col xl='12' sm='12'>
                    <HorizontalBarChart
                        width={30}
          ...
          <Show IF={ViewActivity}>
            <Col xl='4' sm='12'>
              {/*activity */}
              <ApexDonutChart key={FM('activity')} />
            </Col>
          </Show>
