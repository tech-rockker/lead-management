...
const RestoreAlert = ({
  ...
  // Success
  successTitle = successTitle ? FM(successTitle) : FM('restore')
  successText = successText ? FM(successText) : FM('item-restore')
  // Failed
  failedTitle = failedTitle ? FM(failedTitle) : FM('failed')
  failedText = failedText ? FM(failedText) : FM('item-restore-failed')
