...
const ConfirmSignAction = ({
  ...
  // Success
  successTitle = successTitle ? FM(successTitle) : FM('signed')
  successText = successText ? FM(successText) : FM('this-journal-is-signed')
  // Failed
  failedTitle = failedTitle ? FM(failedTitle) : FM('failed')
  failedText = failedText ? FM(failedText) : FM('signed-failed')
...
export default ConfirmSignAction
