...
const ConfirmAction = ({
  ...
  // Success
  successTitle = successTitle ? FM(successTitle) : FM('active')
  successText = successText ? FM(successText) : FM('this-journal-is-active')
  // Failed
  failedTitle = failedTitle ? FM(failedTitle) : FM('failed')
  failedText = failedText ? FM(failedText) : FM('activation-failed')
