    ...
    <Fragment>
      <Card>
        <CardBody className='text-center'>
          ...
          <CardText>
            Quickly collect the credit card details, built in input mask and form validation
            support.
          </CardText>
        ...
        <ModalBody className='px-sm-5 mx-50 pb-5'>
          ...
          <Row tag='form' className='gy-1 gx-2 mt-75' onSubmit={handleSubmit(onSubmit)}>
            <Col xs={12}>
              ...
              {errors.cardNumber && (
                <FormFeedback className='d-block'>Please enter valid card number</FormFeedback>
              )}
            </Col>
            <Col md={6}>
