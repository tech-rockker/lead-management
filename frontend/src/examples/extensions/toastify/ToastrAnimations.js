...
const ToastAnimations = () => {
  const notifyBounce = () =>
    toast.success(<SuccessToast />, { icon: false, transition: Bounce, hideProgressBar: true })
  const notifyFlip = () =>
    toast.warning(<WarningToast />, { icon: false, transition: Flip, hideProgressBar: true })
  const notifyZoom = () =>
    toast.error(<ErrorToast />, { icon: false, transition: Zoom, hideProgressBar: true })
  const notifySlide = () =>
    toast.info(<InfoToast />, { icon: false, transition: Slide, hideProgressBar: true })
