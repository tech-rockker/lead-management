  ...
  return (
    <div className='demo-inline-spacing'>
      ...
      <UncontrolledPopover trigger='focus' placement='top' target='popFocus'>
        ...
        <PopoverBody>
          Focusing on the trigging element makes this popover appear. Blurring (clicking away) makes
          it disappear. You cannot select this text as the popover will disappear when you try.
        </PopoverBody>
      </UncontrolledPopover>
      ...
      <UncontrolledPopover trigger='click' placement='top' target='popClick'>
        ...
        <PopoverBody>
          Clicking on the triggering element makes this popover appear. Clicking on it again will
          make it disappear. You can select this text, but clicking away (somewhere other than the
      ...
      <UncontrolledPopover placement='top' target='popLegacy'>
        ...
        <PopoverBody>
          ...
          useful and has been brought back as trigger="legacy". One advantage of the legacy trigger
          is that it allows the popover text to be selected while also closing when clicking outside
